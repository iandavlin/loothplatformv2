...
echo
echo "=== GATE 6/7: dest-capture (the post-auth destination validator) ==="
php "$(dirname "$0")/dest-capture-gate.php" || red=1
echo
echo "=== GATE 7/7: login-doors (every sign-in door carries the destination) ==="
php "$(dirname "$0")/login-doors-gate.php" || red=1
echo

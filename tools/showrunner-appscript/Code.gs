...
const CONFIG = {
  ...
  WP_DEFAULT_BASE_URL: 'https://dev2.loothgroup.com',
...
//   WP_BASE_URL       e.g. https://dev2.loothgroup.com
...
function setWpCredentials() {
  ...
  const r1 = ui.prompt('WP Base URL', 'e.g. https://dev2.loothgroup.com (no trailing slash)', ui.ButtonSet.OK_CANCEL);

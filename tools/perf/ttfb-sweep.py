...
show("/archive/","https://dev2.loothgroup.com/archive/")
show("/archive-poc/ (hub)","https://dev2.loothgroup.com/archive-poc/")
show("CPT video standalone","https://dev2.loothgroup.com/post-type-videos/3d-club-live-3d-scanning-demo-with-jerry-lynn-and-luke-heaton/")
show("CPT imgcap standalone","https://dev2.loothgroup.com/post-imgcap/f5-l-mandolin-binding-repair/")
show("/u/gerryhayes (profile-app)","https://dev2.loothgroup.com/u/gerryhayes")
show("/lgjoin/","https://dev2.loothgroup.com/lgjoin/")
show("/membership-guide/","https://dev2.loothgroup.com/membership-guide/")
print("\n=== backend APIs (logged-in) ===")
show("search?limit=24 (cards)","https://dev2.loothgroup.com/archive-api/v0/search?limit=24")
show("rows-more (discover row)","https://dev2.loothgroup.com/archive-api/v0/rows-more?row_id=latest&offset=0",both=False)
def one(l,u,ck):
    m,i,x,c,s=t(u,ck);print("%-30s %5.0f ms [%4.0f-%4.0f] %s"%(l,m,i,x,c))
one("profile-api whoami (fast)","https://dev2.loothgroup.com/profile-api/v0/whoami",LOGGED)
one("looth/v1 whoami (OLD shim)","https://dev2.loothgroup.com/wp-json/looth/v1/whoami",LOGGED)

...
drives the actual controls, in Chrome, at both widths:
    ...
    ⚠️ THE MODAL PHASE WAS REMOVED, not lost. This tool used to drive the hub's
    injected Loothprint modal too. Ian ruled on 2026-08-15 that the form LEAVES
    the modal (main commit 4dbb192 killed the embed), so #lpm-body no longer
    exists and every assertion against it would have been vacuous or red for the
    wrong reason. The standalone loop below is the whole surface now.

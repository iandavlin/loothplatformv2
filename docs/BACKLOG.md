...
35. GUITARDLE REPEAT — DUPLICATE PHRASE TEXT (Ian caught it on live 8/15): "DAN ERLEWINE" lives under BOTH phrase ids 180 and 233, so members got the same puzzle on June 23 (day 12) and again Aug 15 (day 65). The no-repeat shuffle itself is sound (285 unique ids, first wrap 2027); the dupe TEXT defeated it. Fix: retext one dupe id (no index/sequence changes), plus a red-first no-duplicate-texts gate. OWNED: guitardle-fairness seat, job 1 of the fresh charter.

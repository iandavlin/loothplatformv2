...
`tools/gates/notif-read-seen-gate.py`, gate 21/21. 35 assertions: the store contract
...
⚠️ **This heading is deliberately NOT the one the gate looks for.** Gate 21 searches
...
21 red, and the correct response to that red is to record the decision — **not** to

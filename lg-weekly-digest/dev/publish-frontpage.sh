...
#
# THE SOURCE IS IN THE REPO (dev/previs-frontpage/index.html). This script only
...
SRC="$LANE/lg-weekly-digest/dev/previs-frontpage/index.html"
DEST=/srv/lg-layout-v2/tests/output/wd-frontpage
URL=https://dev2.loothgroup.com/v2/tests/output/wd-frontpage/index.html

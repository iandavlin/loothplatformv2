...
#
# THE SOURCE IS IN THE REPO (dev/previs-frame-width/index.html). This script only
...
SRC="$LANE/lg-weekly-digest/dev/previs-frame-width/index.html"
DEST=/srv/lg-layout-v2/tests/output/wd-frame-width
URL=https://dev2.loothgroup.com/v2/tests/output/wd-frame-width/index.html

...
#
# Frames (spec §7):
#   card-*    mock-card.html   — feed card, two icons (IAN GATED 2026-07-27) + the mobile proposal
...
#   account-* mock-account.html — account email prefs, the third "Discussion emails" row
#   legacy-*  mock-legacy.html  — the 1,519 existing subs, shown as a member experiences them
#
...
# 1 · feed card — Ian gated the two-icon design 2026-07-27; mobile is the proposal
shot mock-card.html  ""            1280x1400 "card-d-light"
shot mock-card.html  "?theme=dark" 1280x1400 "card-d-dark"
shot mock-card.html  ""            390x1350  "card-m-light"
shot mock-card.html  "?theme=dark" 390x1350  "card-m-dark"

# 2 · discussion modal header + the ≤640 sheet-header proposal
shot mock-modal.html ""            1280x1300 "modal-d-light"
shot mock-modal.html "?theme=dark" 1280x1300 "modal-d-dark"

# 3 · email unsubscribe page
...
# 4 · notifications panel — row menu carries both bits
...
# 5 · account email prefs — the coexistence proposal (spec §6)
shot mock-account.html ""            1280x1400 "account-d-light"
shot mock-account.html "?theme=dark" 1280x1400 "account-d-dark"
shot mock-account.html ""            390x1500  "account-m-light"

# 6 · the 1,519 existing subscriptions — the grandfathering proposal (spec §9.2)
shot mock-legacy.html  ""            1280x1500 "legacy-d-light"
shot mock-legacy.html  "?theme=dark" 1280x1500 "legacy-d-dark"

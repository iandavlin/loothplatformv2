...
(function () {
  ...
  /* @username editor REMOVED (Ian numbered ruling 2026-07-25: the handle follows
     the profile name — display-only chip; renames re-derive it server-side via
     Provision::maybeSyncSlugFromName. me-slug API is GET-only display. */

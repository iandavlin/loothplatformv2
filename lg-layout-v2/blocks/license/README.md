...
Block implementation for `license`. See the [design doc](../../docs/blocks/license.md) for purpose, schema, and visual reference.
...
- Fixture: [tests/fixtures/license-minimal.json](../../tests/fixtures/license-minimal.json)
- Run isolation: `bin/render-test.php --fixture=license-minimal`
- Run cascade: `bin/render-test.php --all`
- Run lint: `bin/lint-block.php license`

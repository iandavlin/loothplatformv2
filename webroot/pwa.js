...
(function () {
  ...
  if (onHub) {
    ...
    inject('looth-hub-polish-js', '/hub-polish.js?v=226', true);
  ...
  inject('looth-tabbar-js', '/bottom-nav.js?v=32');   // v32: notification rows deep-link (notifications lane)
  ...
  if (mobileish) {
    ...
    idle('looth-msgr-js', '/messenger-sheet.js?v=2');          // DM pull-up
